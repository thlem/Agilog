            ...
            UserDAS.getUserBy(User, param, function(error, user) {
                ...
                if (user) {
                    ...
                    var updatePromise = new Promise(function(resolve, reject) {
                        ...
                        if (arrayOfUserDataFromRequest.usrLogin !== undefined && arrayOfUserDataFromRequest.usrLogin !== "" && arrayOfUserDataFromRequest.usrLogin !== user.usrLogin) {

                            console.log("[WORKING][AccountManageService][updateLoginInfo] Promise : login détecté");

                            var param = {
                                "usrLogin": arrayOfUserDataFromRequest.usrLogin
                            };
                            UserDAS.getUserBy(User, param, function(error, user) {
                                if (user) {
